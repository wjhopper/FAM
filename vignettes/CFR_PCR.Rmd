...
params:
  ...
  model: CFR_PCR
  routine: minimize
  pars: !r c("ER","LR","Ta","TR","Tmin","Tmax","lambda","stop")
  fixed: !r c(FR=0,theta=.5,nFeat=100,nSim=1000,nList=15,Time=90, NDTrate=1)
---
...
```{r set_model}
free <- list(c(ER=.60,LR=.01,Ta=125,TR=.01,Tmin=.1,Tmax=45,lambda=.5,stop=45), #1
             c(ER=.525,LR=.05,Ta=75,TR=.01,Tmin=.1,Tmax=45,lambda=.8,stop=45), #2
             c(ER=.52,LR=.06,Ta=200,TR=.01,Tmin=.1,Tmax=45,lambda=.75,stop=45), #3
             c(ER=.525,LR=.05,Ta=125,TR=.01,Tmin=.1,Tmax=45,lambda=.75,stop=45), #4
             c(ER=.53,LR=.06,Ta=150,TR=.03,Tmin=.1,Tmax=45,lambda=.8,stop=45), #5
             c(ER=.52,LR=.09,Ta=125,TR=.02,Tmin=.1,Tmax=45,lambda=.65,stop=45), #6
             c(ER=.524,LR=.09,Ta=150,TR=.025,Tmin=.1,Tmax=45,lambda=.9,stop=45), #7
             c(ER=.54,LR=.06,Ta=350,TR=.01,Tmin=.1,Tmax=45,lambda=.8,stop=45), #8
             c(ER=.5,LR=.06,Ta=80,TR=.015,Tmin=.1,Tmax=45,lambda=.9,stop=45), #9 
             c(ER=.55,LR=.075,Ta=100,TR=.01,Tmin=.1,Tmax=45,lambda=.75,stop=45), #10
             c(ER=.52,LR=.075,Ta=150,TR=.02,Tmin=.1,Tmax=45,lambda=.75,stop=45), #11
             c(ER=.55,LR=.07,Ta=150,TR=.04,Tmin=.1,Tmax=45,lambda=.85,stop=45), #12
             c(ER=.57,LR=.045,Ta=125,TR=.03,Tmin=.1,Tmax=45,lambda=.75,stop=45), #13
             c(ER=.5,LR=.09,Ta=100,TR=.02,Tmin=.2,Tmax=30,lambda=.9,stop=30), #14
             c(ER=.52,LR=.09,Ta=200,TR=.01,Tmin=.1,Tmax=45,lambda=.85,stop=45), #15
             c(ER=.53,LR=.05,Ta=150,TR=.035,Tmin=.2,Tmax=20,lambda=.9,stop=20), #16
             c(ER=.52,LR=.12,Ta=100,TR=.035,Tmin=.1,Tmax=45,lambda=.7,stop=45), #17
             c(ER=.56,LR=.09,Ta=200,TR=.03,Tmin=.1,Tmax=45,lambda=.75,stop=45), #18
             c(ER=.53,LR=.09,Ta=125,TR=.02,Tmin=.1,Tmax=45,lambda=.6,stop=45), #19
             c(ER=.53,LR=.09,Ta=80,TR=.05,Tmin=.1,Tmax=60,lambda=.75,stop=60), #20
             c(ER=.515,LR=.09,Ta=100,TR=.025,Tmin=.1,Tmax=45,lambda=.85,stop=45), #21
             c(ER=.53,LR=.09,Ta=80,TR=.04,Tmin=.1,Tmax=45,lambda=.65,stop=45), #22
             c(ER=.53,LR=.04,Ta=200,TR=.03,Tmin=.1,Tmax=45,lambda=.75,stop=45), #23
             c(ER=.55,LR=.06,Ta=120,TR=.06,Tmin=.1,Tmax=45,lambda=.75,stop=45), #24
             c(ER=.57,LR=.015,Ta=250,TR=.03,Tmin=.1,Tmax=45,lambda=.75,stop=45), #25
             c(ER=.53,LR=.05,Ta=80,TR=.035,Tmin=.1,Tmax=45,lambda=.85,stop=45), #26
             c(ER=.535,LR=.02,Ta=100,TR=.09,Tmin=.1,Tmax=20,lambda=.9,stop=20), #27
             c(ER=.53,LR=.05,Ta=100,TR=.03,Tmin=.1,Tmax=45,lambda=.75,stop=45), #28
             c(ER=.51,LR=.06,Ta=150,TR=.03,Tmin=.1,Tmax=45,lambda=.9,stop=45), #29
             c(ER=.55,LR=.04,Ta=120,TR=.02,Tmin=.1,Tmax=45,lambda=.7,stop=45), #30
             c(ER=.505,LR=.08,Ta=150,TR=.04,Tmin=.1,Tmax=45,lambda=.7,stop=45), #31
             c(ER=.52,LR=.08,Ta=150,TR=.02,Tmin=.1,Tmax=60,lambda=.95,stop=60), #32
             c(ER=.57,LR=.06,Ta=120,TR=.02,Tmin=.1,Tmax=45,lambda=.7,stop=45), #33
             c(ER=.54,LR=.09,Ta=120,TR=.06,Tmin=.1,Tmax=45,lambda=.65,stop=45)) #34
