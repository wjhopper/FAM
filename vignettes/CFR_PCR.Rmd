...
```{r set_model}
free <- list(c(ER=.6,LR=.025,Ta=150,TR=.01,Tmin=.3,Tmax=45,lambda=.5,stop=45), #1
             c(ER=.525,LR=.05,Ta=75,TR=.01,Tmin=.3,Tmax=45,lambda=.85,stop=45), #2
             c(ER=.52,LR=.06,Ta=200,TR=.01,Tmin=.3,Tmax=45,lambda=.75,stop=45), #3
             c(ER=.525,LR=.05,Ta=125,TR=.01,Tmin=.4,Tmax=45,lambda=.75,stop=45), #4
             c(ER=.53,LR=.06,Ta=150,TR=.03,Tmin=.3,Tmax=45,lambda=.8,stop=45), #5
             c(ER=.52,LR=.09,Ta=125,TR=.02,Tmin=.4,Tmax=45,lambda=.65,stop=45), #6
             c(ER=.524,LR=.09,Ta=150,TR=.025,Tmin=.3,Tmax=45,lambda=.9,stop=45), #7
             c(ER=.54,LR=.06,Ta=350,TR=.01,Tmin=.3,Tmax=45,lambda=.8,stop=45), #8
             c(ER=.5,LR=.06,Ta=80,TR=.015,Tmin=.3,Tmax=45,lambda=.9,stop=45), #9
             c(ER=.55,LR=.075,Ta=100,TR=.01,Tmin=.3,Tmax=45,lambda=.75,stop=45), #10
             c(ER=.52,LR=.075,Ta=150,TR=.02,Tmin=.3,Tmax=45,lambda=.75,stop=45), #11
             c(ER=.55,LR=.07,Ta=150,TR=.04,Tmin=.3,Tmax=45,lambda=.85,stop=45), #12
             c(ER=.57,LR=.045,Ta=125,TR=.03,Tmin=.4,Tmax=45,lambda=.75,stop=45), #13
             c(ER=.54,LR=.09,Ta=125,TR=.03,Tmin=.3,Tmax=45,lambda=.75,stop=45), #14
             c(ER=.52,LR=.09,Ta=200,TR=.01,Tmin=.4,Tmax=45,lambda=.85,stop=45), #15
             c(ER=.55,LR=.08,Ta=150,TR=.04,Tmin=.3,Tmax=35,lambda=.85,stop=35), #16
             c(ER=.52,LR=.12,Ta=100,TR=.035,Tmin=.3,Tmax=45,lambda=.7,stop=45), #17
             c(ER=.56,LR=.09,Ta=200,TR=.03,Tmin=.3,Tmax=45,lambda=.75,stop=45), #18
             c(ER=.53,LR=.09,Ta=125,TR=.02,Tmin=.5,Tmax=40,lambda=.8,stop=40), #19
             c(ER=.53,LR=.09,Ta=80,TR=.05,Tmin=.3,Tmax=60,lambda=.75,stop=60), #20
             c(ER=.5,LR=.07,Ta=250,TR=.025,Tmin=.2,Tmax=25,lambda=1.5,stop=25), #21
             c(ER=.53,LR=.09,Ta=80,TR=.04,Tmin=.3,Tmax=45,lambda=.65,stop=45), #22
             c(ER=.55,LR=.04,Ta=200,TR=.03,Tmin=.3,Tmax=45,lambda=.9,stop=45), #23
             c(ER=.55,LR=.06,Ta=120,TR=.06,Tmin=.3,Tmax=45,lambda=.75,stop=45), #24
             c(ER=.57,LR=.015,Ta=250,TR=.03,Tmin=.3,Tmax=45,lambda=.75,stop=45), #25
             c(ER=.53,LR=.05,Ta=80,TR=.035,Tmin=.3,Tmax=45,lambda=.85,stop=45), #26
             c(ER=.54,LR=.02,Ta=100,TR=.06,Tmin=.3,Tmax=45,lambda=.9,stop=45), #27
             c(ER=.53,LR=.05,Ta=100,TR=.03,Tmin=.4,Tmax=45,lambda=.75,stop=45), #28
             c(ER=.51,LR=.06,Ta=150,TR=.03,Tmin=.3,Tmax=45,lambda=.9,stop=45), #29
             c(ER=.56,LR=.05,Ta=120,TR=.02,Tmin=.3,Tmax=45,lambda=.7,stop=45), #30
             c(ER=.505,LR=.08,Ta=150,TR=.04,Tmin=.3,Tmax=45,lambda=.7,stop=45), #31
             c(ER=.52,LR=.08,Ta=150,TR=.02,Tmin=.4,Tmax=60,lambda=.95,stop=60), #32
             c(ER=.57,LR=.06,Ta=120,TR=.02,Tmin=.3,Tmax=45,lambda=.7,stop=45), #33
             c(ER=.54,LR=.09,Ta=120,TR=.06,Tmin=.3,Tmax=45,lambda=.65,stop=45)) #34
